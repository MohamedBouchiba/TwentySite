...
Tags: Elementor, Elemetor Addons, Elemetor Widgets, elementor page builder, Elementor Blocks
...
== Requirements ==
To run our plugin we recommend your host supports

* [PHP](https://secure.php.net/) version 7.3 or greater.
* [MySQL](https://www.mysql.com/) version 5.6 or greater OR [MariaDB](https://mariadb.org/) version 10.0 or greater.
...
> ##How to install landing pages
> 1.  Download JSON File from [HT Plugins Website](https://htplugins.com/free-download-landing-page-json-file/)
> 2.  Go to your Website WordPress Dashboard
> 3.  Elementor --> My Templates
> 4.  Import your preferred JSON file.

> [Download](https://htplugins.com/free-download-landing-page-json-file/)
