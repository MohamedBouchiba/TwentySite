...
function countdown_timer_plugin_activation() {
    ...
    $notices[] = '<p>Hi, you are now using <strong>Countdown Timer</strong> plugin. I would really appreciate it if you could give me the five star to our plugin. </p><p><a href="https://wordpress.org/plugins/" target="_blank" class="rating-link"><strong> Okay, you deserve it </strong></a></p>';
